...
При изменении текста, услуг, demo-блоков или списка дополнительных функций нужно обновлять все 3 языка.
...
Эта страница нужна для обсуждения проекта с заказчиком. На ней повторяется demo-блок и показаны функции, которые можно добавить в бота и сайт.

Список блоков меняется в `landing/config.js` в поле:
